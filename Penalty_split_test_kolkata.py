...
gc = pygsheets.authorize(service_file='operation.json')


all_in_one_gs = gc.open("All in One Form - Kolkata")


i = 0
while i < 30:
    all_in_one_responses_tab = all_in_one_gs[i]
    if all_in_one_responses_tab.title == "Responses":
        break
    i +=1
...
penalty_responses = all_in_one_responses[['Timestamp','ETK','Team Name','Pilot Name','Penalty Reason','Date of Penalty','Penalty Comment','Car Number','Name of DM']]
...
penalty_response_dead_km = all_in_one_responses[['Timestamp','ETK','Team Name','Pilot Name','Dead KM/Car Misuse - Please insert only KM','Date of Penalty','Penalty Comment','Car Number','Name of DM']]
...
penalty_final = penalty_final[['Timestamp','ETK','Team Name','Pilot Name','Date of Penalty','Penalty Comment','Penalty Reason Final','Amount','Car Number','Name of DM']]
